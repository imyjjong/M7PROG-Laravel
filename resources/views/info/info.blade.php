        ...
        <section class="bg-lighten w-full h-80 p-8 flex flex-col justify-center items-start gap-4">
            ...
            <ul class="flex flex-col justify-center items-start gap-2">
                <li class="flex  justify-center items-center">
                    So basically, u just click the 
                    <p class="flex justify-center items-center text-xs text-color bg-flashyButton rounded-md py-1 px-2 w-max font-bold ml-2">+ add movie</p>
                </li>
                <li>and just enter a movie name</li>
                <li>then you fill out the other fields</li>
                <li>submit your movie</li>
                <li>the site will now try to find the right movie poster and add it to the database</li>
