<header class="text-headerColor text-3xl flex justify-between align-center p-4 px-60 bg-headerBackground">  
    ...
    <nav class="flex justify-center align-center px-4">
        ...
        <p class="flex justify-center items-center text-xl text-color bg-flashyButton rounded-md py-1 px-2 w-max font-bold ml-8 hover:bg-accentHover transition-all duration-300">
